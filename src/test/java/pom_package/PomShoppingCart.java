...
public class PomShoppingCart extends BaseClass{
	...
	@FindBy(xpath = "//*[@id=\"acrPopover\"]")WebElement review;
	@FindBy(xpath = "//span[contains(text(),'Mens Force Relaxed Fit Midweight Short Sleeve Pock')]")
	WebElement productresult;
	@FindBy(xpath = "//div//span//div[@data-component-type='s-search-result']//div[@cel_widget_id='-SEARCH_MAINRESULTS-22']")
	WebElement Nthproduct;
	@FindBy(xpath = "add-to-cart-button")WebElement AddtoCart;
